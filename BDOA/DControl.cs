...
namespace BDOA
{
    internal class DControl
    {
        ...
        internal void SInput(string s)
        {
            foreach (var q in s)
                if (Speed < 5)
                    _is.SendKeys(Conv(q));//_is.Keyboard.KeyPress((VirtualKeyCode)Enum.Parse(typeof(VirtualKeyCode), "VK_" + q));
                else
                    KPress(Conv(q));

        }

        internal Keys Conv(char s)
        {
            if (s == '0')
                return Keys.Zero;
            if (s == '1')
        ...
        internal void KPress(Keys vk, bool qwe = false)
        {
            if (Speed > 5 && !qwe)
            {
        ...
        {
            _is.MoveMouseTo(tx, ty);//Imports.SetCursorPos(fx, fy);
            //Point pt;
        ...
        //}
        //private void KD(ScanCodeShort SC)
        //{
        ...
        //private void KU(ScanCodeShort SC)
        //{
        //    var input = new Input { type = 1 };
        //    // 1 = Keyboard Input
        //    input.U.ki.wScan = SC;
        ...
        //internal void BACK()
        //{
        //    KD(ScanCodeShort.BACK);
        //    KU(ScanCodeShort.BACK);
        //}
        //internal void ESC()
        //{
        //    KD(ScanCodeShort.ESCAPE);
        //    KU(ScanCodeShort.ESCAPE);
        //}
        //internal void RETURN()
        //{
        //    KD(ScanCodeShort.RETURN);
        //    KU(ScanCodeShort.RETURN);
        //}
        //#endregion
    }
}
